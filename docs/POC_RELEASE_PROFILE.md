# Run a customer POC with Verdict 0.1.0a10
...
The final command must print `0.1.0a10 0.1.0a10 0.1.0a10`. Add the `postgres`
...
1. All three installed packages report `0.1.0a10` and `python -m pip check` passes.
