# Run a customer POC with Verdict 0.1.0a20
...
The final command must print `0.1.0a20 0.1.0a20 0.1.0a20`. Add the `postgres`
...
1. All three installed packages report `0.1.0a20` and `python -m pip check` passes.
