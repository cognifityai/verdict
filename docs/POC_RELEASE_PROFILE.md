# Run a customer POC with Verdict 0.1.0a9
...
The final command must print `0.1.0a9 0.1.0a9 0.1.0a9`. Add the `postgres`
...
1. All three installed packages report `0.1.0a9` and `python -m pip check` passes.
