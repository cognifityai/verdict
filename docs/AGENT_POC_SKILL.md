...
mkdir /absolute/path/to/cognifity-skills/verdict-instrument-app-0.1.0a21
curl -fsSL https://github.com/cognifityai/verdict/archive/refs/tags/v0.1.0a21.tar.gz \
  | tar -xz \
      -C /absolute/path/to/cognifity-skills/verdict-instrument-app-0.1.0a21 \
      --strip-components=3 \
      verdict-0.1.0a21/skills/verdict-instrument-app
```

This creates
`/absolute/path/to/cognifity-skills/verdict-instrument-app-0.1.0a21/SKILL.md`.
...
```text
Read /absolute/path/to/cognifity-skills/verdict-instrument-app-0.1.0a21/SKILL.md completely
