...
```bash
python -m pip install "cognifity-verdict[telemetry]==0.1.0a17"
...
[`POC release profile`](POC_RELEASE_PROFILE.md). Release `0.1.0a17` includes the
...
For PostgreSQL, install `cognifity-verdict[dashboard,postgres]==0.1.0a17` and pass
