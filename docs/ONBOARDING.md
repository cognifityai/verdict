...
customer POC data. The `0.1.0a11` POC profile also keeps
...
[`POC release profile`](POC_RELEASE_PROFILE.md). Release `0.1.0a11` includes the
...
For PostgreSQL, install `cognifity-verdict[dashboard,postgres]==0.1.0a11` and pass
