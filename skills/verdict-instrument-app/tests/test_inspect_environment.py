...
def test_a8_environment_is_current(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_storage_report_exposes_backend_but_never_secret(
    ...
    report = inspect(monkeypatch, synchronized("0.1.0a8"), storage=storage)
