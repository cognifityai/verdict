...
python -m pip install \
  "cognifity-verdict[anthropic,dashboard]==0.1.0a21" \
...
or evaluation history. Run the tenant-scoped `verdict-cluster normalize`
...
`0.1.0a21` includes the Agent Run SDK, process-owned JSONL capture segments,
