...
RULES: tuple[Rule, ...] = (
    ...
    _rule(
        ...
        "unsupported",
        "Do not claim released auto-instrumentation; use messages.create(stream=True) only if behavior permits, or propose an unverified adapter.",
    ),
    _rule(
    ...
    _rule(
        ...
        "unsupported",
        "Released auto-instrumentation does not cover the Responses API; mark it unsupported or use a separately approved unverified adapter.",
    ),
    _rule(
